...
// Use browser for cookies
const USE_BROWSER_COOKIES = true; // Set to false to use a cookie file
...
app.get("/get-qualities", (req, res) => {
    ...
    const ytDlpArgs = ["-F", videoUrl];

    if (USE_BROWSER_COOKIES) {
        ytDlpArgs.push("--cookies-from-browser", "chrome"); // Use browser cookies
    } else {
        const cookiesFilePath = path.join(__dirname, "youtube_cookies.txt");
        ytDlpArgs.push("--cookies", cookiesFilePath); // Use cookie file
    }
